...
export default function Output() {
  return (
    <DocsLayout
      ...
      lede="Structured JSON by default, saved under .data-scout/ unless you say otherwise — with an optional readable markdown mode."
      toc={toc}
    >
      ...
      <p>Every command's default <code>--out</code> path lives under <code>.data-scout/</code>, created automatically next to wherever you run the command — e.g. <code>.data-scout/web_search_results.json</code>.</p>
      ...
      <pre><code>{`scout-it github-repo --repo psf/requests --markdown          # .data-scout/github_repo_results.md
