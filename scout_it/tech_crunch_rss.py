...
TECHCRUNCH_FEEDS: Dict[str, List[Dict[str, Any]]] = {
    ...
    "media": [
        ...
        {"url": "https://www.theverge.com/entertainment/rss/index.xml", "verified": True, "notes": "The Verge entertainment feed."},
        {"url": "https://www.wired.com/category/culture/feed/rss", "verified": False, "notes": "WIRED culture/media overlap feed pattern; verify in your environment."},
    ],
    "apple": [
        {"url": "https://techcrunch.com/tag/apple/feed/", "verified": True, "notes": "TechCrunch Apple tag feed."},
        {"url": "https://9to5mac.com/feed/", "verified": True, "notes": "9to5Mac main feed."},
        {"url": "https://www.macrumors.com/feed/", "verified": True, "notes": "MacRumors feed."},
    ],
    "google": [
    ...
    "meta": [
        ...
        {"url": "https://about.fb.com/news/category/meta/feed/", "verified": False, "notes": "Meta newsroom feed pattern; verify in your environment."},
    ],
    "businesses": [
        {"url": "https://techcrunch.com/category/business/feed/", "verified": True, "notes": "Alias for business."},
    ],
    "tc": [
